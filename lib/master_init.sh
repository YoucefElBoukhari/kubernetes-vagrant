...
echo -e "\033[0;31m\t\t Master Init Start"
sudo apt-get update > /dev/null 2>&1 && sudo apt-get install -y kubelet=1.25.0-00 kubeadm=1.25.0-00 kubectl=1.25.0-00 > /dev/null 2>&1
...
echo -e "\033[0;31m\t\t Master Init Done"
